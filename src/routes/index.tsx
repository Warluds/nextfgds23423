            ...
            {[
              {
                ...
                desc: "Холдинг ABIS Group — освещение, краски и декоративные покрытия. 15 лет на рынке, 500+ партнёров.",
              },
              {
                img: caseEgloImg,
                title: "eglo.kz",
                tag: "ИТ-аутсорсинг · 1С · Серверы · Приложения · Сайт",
                desc: "EGLO — международный бренд декоративного и технического освещения для дома и бизнеса.",
              },
              {
                img: caseImpulseImg,
                title: "impulse-media.kz",
                tag: "Веб-разработка · Корпоративный сайт",
                desc: "Маркетинговое агентство в Алматы: Instagram-маркетинг, реклама, айдентика, видеопродакшн и сайты.",
              },
              {
                img: caseAbisGroupImg,
                title: "abis.group",
                tag: "Веб-разработка · Корпоративный сайт",
                desc: "Сайт холдинга ABIS Group: SVET.KZ, Центр Красок №1 и ABIS Import — направления, кейсы и контакты.",
              },
              {
                img: caseDeltaImg,
                title: "deltaminingcons.kz",
                tag: "Веб-разработка · Корпоративный сайт",
                desc: "DELTA Mining Consultancy — инженерно-горнодобывающий консалтинг: от геологоразведки до IPO.",
              },
              {
                img: caseMiracodeImg,
                title: "miracode.kz",
                tag: "Веб-разработка · Корпоративный сайт",
                desc: "MIRA CODE — внедрение и разработка на 1С. Официальный партнёр 1С, резидент Astana Hub.",
              },
            ].map((p) => (
